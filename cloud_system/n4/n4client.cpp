...
{
 if(input[0]=='C'&&input[1]=='L'&&input[2]=='I'&&input[3]=='E'&&input[4]=='N'&&input[5]=='T'&&input[6]=='I'&&input[7]=='D') return 5;
 else if(input[0]=='G'&&input[1]=='E'&&input[2]=='T') return 1; // 1 for GET
 ...
 while(1)
 {
  ...
  {	
    ...
    int check=1,five=0;  
 	...
 	if(check==1&&five==5)  write(sock_fd,command,strlen(command)); 
  }
