...
{	
 ...
 else if(input[0]=='P'&&input[1]=='U'&&input[2]=='T') //2 for PUT
 {
   ...
   a=strtok(NULL," ");
   b=strtok(NULL," ");//name
   int w=user[i].clientid;
   user1[w].setfilename(b);
 ...
 else if(input[0]=='C'&&input[1]=='L'&&input[2]=='I'&&input[3]=='E'&&input[4]=='N'&&input[5]=='T'&&input[6]=='I'&&input[7]=='D')
 {
 	 int check=1,id=0;
	 for(int i=10;i<=14;i++)
 	{
